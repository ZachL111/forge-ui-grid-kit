"""Regression checks for the forge-ui-grid-kit casebook."""
...
from casebook.harness import assert_expected, forge_ui_grid_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(forge_ui_grid_kit_summary(), assert_expected())
