...
`forge-ui-grid-kit` is centered on frontend apps work in Lua. The technical target is: Develop a Lua command-oriented project for grid scenarios with layout fixtures, stable geometry snapshots, and fixture-scale datasets.
...
The score is deterministic. The current threshold is 159. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 3.
